                        ...
                        <? foreach(\Yii::$app->shop->shopFuser->shopBaskets as $shopBasket) : ?>
                            ...
                            <div class="item">
                                <div class="cart_img pull-left width-100 padding-10 text-left">
                                    ...
                                    <img data-original="<?= \skeeks\cms\helpers\Image::getSrc(
                                        \Yii::$app->imaging->getImagingUrl($shopBasket->product->cmsContentElement->image->src, new \skeeks\cms\components\imaging\filters\Thumbnail([
                                            'h' => 100,
                                            'w' => 100,
                                        ]))
                                    )?>"  class="sx-lazy" alt="<?=$shopBasket->product->cmsContentElement->name;?> title="<?=$shopBasket->product->cmsContentElement->name;?> width="80" />
                                </div>
