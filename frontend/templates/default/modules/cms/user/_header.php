        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-4">
                <div class="thumbnail text-center">
                    <? if ($model->image) : ?>
                        <img class="" src="<?= \skeeks\cms\helpers\Image::getSrc($model->image->src); ?>" alt="<?=$model->name;?> title="<?=$model->name;?>">
                    <? else : ?>
                        <img class="" src="<?= \skeeks\cms\helpers\Image::getSrc(); ?>" alt="<?=$model->name;?> title="<?=$model->name;?>">
                    <? endif; ?>
                    <h2 class="size-18 margin-top-10 margin-bottom-0"><?= $model->displayName; ?></h2>
