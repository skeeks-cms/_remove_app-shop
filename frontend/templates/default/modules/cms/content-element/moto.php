            ...
            <div class="col-lg-9 col-md-9 col-sm-9">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6">
                            ...
                            <figure id="zoom-primary" class="zoom" data-mode="mouseover" style="position: relative; overflow: hidden;">
                                <!--
                                    ...
                                    positions available:
                                        ...
                                        .top-left
                                -->
                                <a class="lightbox sx-fancy bottom-right " title="<?= $model->image->name; ?>" href="<?= \Yii::$app->imaging->thumbnailUrlOnRequest($model->image->src,
                                ...
                                <a class="sx-fancybox-gallary" style="display: none;" data-fancybox-group="gallery" href="<?= \Yii::$app->imaging->thumbnailUrlOnRequest($model->image->src,
                                    new \common\thumbnails\MediumWatermark(), $model->code, $model->code
                                ) ?>" title="<?=$model->image->name; ?>"></a>

                                <img src="/img/loader/loader-2.GIF" class="img-responsive sx-lazy" data-original="<?= \Yii::$app->imaging->thumbnailUrlOnRequest($model->image->src,
                                    new \common\thumbnails\MediumWatermark(), $model->code, $model->code
                        ...
                        <div data-for="zoom-primary" class="zoom-more owl-carousel owl-padding-3 featured sx-thumbnail" data-plugin-options='{"singleItem": false, "autoPlay": false, "navigation": true, "pagination": false, "items": 4, "progressBar":"false"}' style="opacity: 1; display: block;">

                                <? foreach ($gallery as $image) : ?>
                                    <a class="sx-fancybox-gallary" style="display: none;" data-fancybox-group="gallery" href="<?= \Yii::$app->imaging->thumbnailUrlOnRequest($image->src,
                                    new \common\thumbnails\MediumWatermark(), $model->code, $model->code
                                ) ?>" title="<?=$image->name; ?>"></a>

                                    <a class="thumbnail" href="<?= \Yii::$app->imaging->thumbnailUrlOnRequest($image->src,
                                        new \common\thumbnails\MediumWatermark(), $model->code, $model->code
                                    ) ?>" title="<?=$image->name; ?>">
                                        <img src="/img/loader/loader-2.GIF" data-original="<?= \Yii::$app->imaging->thumbnailUrlOnRequest($image->src,
                                            new \skeeks\cms\components\imaging\filters\Thumbnail([
                                                'h'    => 100,
                                                'w'    => 0,
                                            ])
                                        ) ?>" class="sx-lazy" height="100" alt="<?=$image->name; ?>" title="<?=$image->name; ?>" style="min-height: 100px">
                                    </a>
                                    <? endforeach; ?>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="clearfix margin-bottom-30">
                            ...
                            <? if ($model->relatedPropertiesModel->getAttribute('availability')) : ?>
                                <strong>Наличие:</strong> <?= $model->relatedPropertiesModel->getSmartAttribute('availability'); ?><br />
                            <? endif; ?>
                        ...
                        <hr>
                            ...
                            <a class="btn btn-default btn-primary btn-lg product-add-cart noradius" href="#" onclick="sx.Shop.addProduct(<?= $model->id; ?>, 1); return false;"><i class="fa fa-cart-plus"></i> В корзину</a><br /><br />
                            <a class="btn btn-default btn-primary btn-lg product-add-cart noradius sx-fancybox" href="#sx-form-feedback">
