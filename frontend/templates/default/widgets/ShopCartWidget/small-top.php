            ...
            <div class="quick-cart-wrapper">
                ...
                <? foreach(\Yii::$app->shop->shopFuser->shopBaskets as $shopBasket): ?>
                    <a href="<?= $shopBasket->product->cmsContentElement->url; ?>"><!-- cart item -->
                        <img src="/img/loader/loader-2.GIF" data-original="<?= \Yii::$app->imaging->getImagingUrl($shopBasket->product->cmsContentElement->image->src, new \skeeks\cms\components\imaging\filters\Thumbnail()); ?>" width="45" height="45" alt="<?= $shopBasket->product->cmsContentElement->name; ?>" title="<?= $shopBasket->product->cmsContentElement->name; ?>" class="sx-lazy"/>
